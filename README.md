...
In this particular example, we have added an endpoint named "custom-data" which can be tested by passing the --custom_data <MyCustomData> option to the esp_prov tool. Following output is expected on success:
